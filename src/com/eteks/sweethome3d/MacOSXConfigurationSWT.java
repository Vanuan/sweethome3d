 ...
 */
class MacOSXConfigurationSWT {
  /**
   * Binds <code>homeApplication</code> to Mac OS X application menu.
   */
  public static void bindToApplicationMenu(final SweetHome3DSWT homeApplication) {
    ...
    homeApplication.addHomesListener(new CollectionListener<Home>() {
      public void collectionChanged(CollectionEvent<Home> ev) {
        if (ev.getType() == CollectionEvent.Type.ADD) {
          ...
          MacOSXConfigurationSWT.addWindowMenu(
   ...
   */
  private static JFrame createDummyFrameWithDefaultMenuBar(final SweetHome3DSWT homeApplication,
  ...
  private static void addWindowMenu(final JFrame frame, 
    ...
    windowMenu.add(new JMenuItem(
        new ResourceAction(preferences, MacOSXConfigurationSWT.class, "ZOOM", !defaultFrame) {
            @Override
            public void actionPerformed(ActionEvent ev) {
    ...
    windowMenu.add(new JMenuItem(
        new ResourceAction(preferences, MacOSXConfigurationSWT.class, "BRING_ALL_TO_FRONT", !defaultFrame) {
            @Override
            public void actionPerformed(ActionEvent ev) {
